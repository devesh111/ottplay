...
export default function SearchPage() {
    ...
    const fetchPage = useCallback(
        async (pageNum, isInitial = false, tabType = activeTab) => {
            ...
            try {
                ...
                const response = await tab.fetchFn({
                    query,
                    limit: LIMIT,
                    type: tabType,
                    page: pageNum,
    ...
    // Reset and re-fetch whenever query or active tab changes
    useEffect(() => {
        setItems([]);
        setNextPage(null);
        setTotalDocs(null);
    ...
    const showEmpty =
        !initialLoading && !error && !!query && items.length === 0;
        ...
        <div className="min-h-screen bg-background">
            ...
            <div className="max-w-7xl mx-auto px-4 py-8">
                ...
                {!initialLoading && !hasMore && totalLoaded > 0 && (
                    <div className="text-center py-12">
                        <p className="text-muted-foreground text-sm">
                            You&apos;ve reached the end — all {totalLoaded}{" "}
                            results loaded.
                        </p>
                    </div>
                )}
