...
export default function ContentDetailPage() {
    ...
    useEffect(() => {
        const fetchContent = async () => {
            try {
                setLoading(true);
                const endpoint =
                    type === "movie" ? "/content/movies" : "/content/shows";
    ...
    const description =
        language === "en" ? content.description : content.descriptionAr;

    return (
        <main className="min-h-screen bg-gray-50">
            {/* Hero Section */}
            <div className="relative h-96 md:h-125 bg-linear-to-b from-gray-900 to-gray-800 overflow-hidden">
                {content.posterUrl ? (
                    <img
                        ...
                        <div className="flex flex-col md:flex-row gap-8 items-end">
                            ...
                            <div className="hidden md:block shrink-0 relative">
                                {content.posterUrl ? (
                                    ...
                                    <div className="w-48 h-72 bg-linear-to-br from-gray-400 to-gray-600 rounded-lg shadow-2xl flex items-center justify-center">
                ...
                <Tabs defaultValue="description" className="w-full">
                    ...
                    <TabsContent value="ratings" className="mt-6">
                        <div className="bg-white rounded-lg p-6 shadow-sm">
                            ...
                            {/* Overall Rating */}
                            <div className="mb-8 p-6 bg-linear-to-r from-yellow-50 to-orange-50 rounded-lg">
