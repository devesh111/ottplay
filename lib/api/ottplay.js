...
export async function fetchSearchAllContent(params) {
    return clientFetch(buildUrl("/api/search-all", params));
}

export async function fetchSearchMovieContent(params) {
    return clientFetch(buildUrl("/api/search-movie", params));
}

export async function fetchSearchShowContent(params) {
    return clientFetch(buildUrl("/api/search-show", params));
}
