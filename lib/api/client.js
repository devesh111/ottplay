...
/**
 * API Base URL - empty string so axios uses relative paths (our own Next.js /api/* routes).
 * The actual external API is called from server-side Route Handlers only.
 * @type {string}
 */
